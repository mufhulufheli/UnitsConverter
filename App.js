  ...
  return(
    <View style={styles.scene}> 
      ...
      <View style={styles.row}>
        ...
        <View style={styles.column}>
          <Text  style={[styles.output, {fontSize: 40 , fontWeight:'bold'}]}> {valueConverted}</Text>
        </View>
      </View>
     </View>
  )
...
function  unCamelCase(value) {
  return value.replace(/([a-z]|[0-9])([A-Z]|[0-9])/g,'$1 $2')
}
export default function App() {
  ...
  return (
    <View style={[styles.scene ,{marginTop: Constants.statusBarHeight}]}>
      ...
      <Text style={styles.title}> Mabilo's Unit converter</Text>
